...
struehow_upload_speed="$(tmux_get @tmux_power_show_upload_speed false)"
...
user=""
# LS="#[fg=$G04,bg=$TC,bold] $user_icon $user#[fg=$TC,bg=$G06,nobold]$rarrow#[fg=$TC,bg=$G06] #S "
LS="#[fg=$G04,bg=$TC,bold] $user_icon $user#[fg=$TC,bg=$G06,nobold]$rarrow#[fg=$TC,bg=$G06] #S "
...
tmux_set window-status-current-format "#[fg=$BG,bg=$TC]$rarrow #[fg=$BG,bg=$TC]#[fg=$BG,bg=$TC,bold] #W #[fg=$TC,bg=$BG,nobold]$rarrow" 
