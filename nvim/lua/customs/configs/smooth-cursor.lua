require('smoothcursor').setup({
    ...
    cursor = "𝔍", -- Cursor shape (requires Nerd Font). Disabled in fancy mode.
    ...
    matrix = { -- Loaded when 'type' is set to "matrix"
        ...
        body = {
            length = 30, -- Specifies the length of the cursor body
    ...
    speed = 1,                 -- Max speed is 100 to stick with your current position
